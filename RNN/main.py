#traditional RNN
#written by: https://github.com/philippmuench/dna_lstm
#edited by: Haley Granger
...
checkpoint_dir = 'C:/Users/arizo/Desktop/checkpoints'
os.path.exists(checkpoint_dir)

input_file = 'C:/Users/arizo/Desktop/PTENtest2.csv'
...
if __name__ == '__main__':
   ...
   # checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=0, save_best_only=True, mode='max')
    ...
    print(class_weight)
    history = model.fit(X_train, y_train, validation_split=0.1, epochs=EPCOHS, batch_size=BATCH_SIZE,
                          verbose=1)
